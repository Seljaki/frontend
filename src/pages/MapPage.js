...
function MapPage() {
  ...
  return (
    <Box style={{ minWidth: "100%", height: "100vh"}}>
      ...
      <MapContainer style={{ height: "100%", width: "100%", backgroundColor: theme.palette.background.default}}  maxZoom={18} center={[46.413874, 16.063868]} crs={sloCRS} zoom={18} scrollWheelZoom={true}>
